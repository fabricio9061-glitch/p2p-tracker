 ...
 */
const CHANGELOG = [
    {version:'5.6.2', date:'2026-08-09', headline:'🧽 Se acabaron los datos repetidos y los últimos emojis.', changes:[
        {type:'improve', title:'El mismo dato aparecía hasta tres veces en Nueva Operación', desc:'Al agregar el resultado en vivo arriba del formulario quedó duplicado lo que ya mostraba el resumen del pie: la cantidad a recibir y la comisión figuraban dos veces en la misma pantalla, y el saldo de la cuenta hasta tres, contando el desplegable. Ahora el resultado en vivo dice qué recibís y con cuánta comisión, y el resumen del pie muestra únicamente cómo queda el saldo de la cuenta después de la operación, que es el único dato que no está en ningún otro lugar.'},
