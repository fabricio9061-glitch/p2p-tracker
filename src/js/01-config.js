...
const CHANGELOG = [
    ...
    {version:'6.0.1', date:'2026-08-16', headline:'🗑️ Retirada la detección de repetidos que marcaba operaciones legítimas.', changes:[
        {type:'fix', title:'Marcaba como error ciento sesenta operaciones normales', desc:'La versión anterior buscaba registros repetidos comparando su contenido: mismo tipo, mismo monto y misma cuenta con pocos minutos de diferencia. En una aplicación de uso general eso tendría sentido, pero acá no: operando P2P se venden muchas veces montos redondos a tasas parecidas en el mismo rato, y eso es trabajo normal, no un error. El resultado fue una lista de ciento sesenta ventas legítimas señaladas como problema. Una lista así es peor que no avisar nada, porque enseña a ignorarla y el día que aparezca un problema real va a pasar desapercibido. Queda solo lo que sí es inequívoco: dos registros que comparten el mismo identificador interno, algo que nunca puede ser correcto.'}
    ]},
