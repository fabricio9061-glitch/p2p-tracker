...
const CHANGELOG = [
    ...
    {version:'5.6.3', date:'2026-08-09', headline:'🎯 Análisis de Gastos con íconos propios y acciones que se pueden tocar.', changes:[
        ...
        {type:'improve', title:'El tipo de cuenta vuelve a tener su ícono', desc:'En Ajuste Externo las opciones Banco y USDT habían quedado como texto suelto, porque las listas desplegables no admiten dibujos dentro de sus opciones. Ahora el ícono se coloca sobre el campo y cambia según lo que elijas; al desplegar la lista, el teléfono sigue mostrando su propio selector.'},
        {type:'improve', title:'Últimos emojis de la interfaz', desc:'Quedaban en los encabezados de editar operación y editar lote, en el aviso de saldo insuficiente del pago dividido, en el cartel de guardado, en los avisos de sincronización y en varios mensajes de error. Todos pasaron a íconos. Los únicos que siguen son los de las ventanas de aviso del navegador, que solo aceptan texto y no permiten dibujos.'}
    ]},
];
